...
using DataFrame = vector<Point>; // vector de puntos (vector de vectores)

inline double square(double value){ // cuadrado de un valor
	return value * value;
}

inline double squared_12_distance(Point first, Point second){// vectores del mismo tamaño (troubleshooting)
